...
py.display.set_caption("The game ship")
...
# Set pause
pause = False
font = py.font.Font(None, 36) #esto se usa para renderizar
WHITE = 255, 255,255 # ah no, me imagino que lo que hace es como una captura de pantalla y lo frezea 
...
# Game loop
def main():
    global contador_bala, actual_ammo, pause
    while True:
        # Event handling
        ...
        # Shooting bullets every 20 frames
        if contador_bala >= 20:
            contador_bala = 0
